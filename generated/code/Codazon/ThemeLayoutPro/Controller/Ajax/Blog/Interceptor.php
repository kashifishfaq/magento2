...
class Interceptor extends \Codazon\ThemeLayoutPro\Controller\Ajax\Blog implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Action\Context $context, \Codazon\ThemeLayoutPro\Block\Widget\BlogPostList $postList)
    {
        $this->___init();
        parent::__construct($context, $postList);
    }
