...
class Interceptor extends \Codazon\ProductFilter\Block\Product\ProductsList implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getUrlHelper()
    {
        ...
        if (!$pluginInfo) {
            return parent::getUrlHelper();
        } else {
            return $this->___callPlugins('getUrlHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getListProduct()
    {
        ...
        if (!$pluginInfo) {
            return parent::getListProduct();
        } else {
            return $this->___callPlugins('getListProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductListBlock()
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductListBlock();
        } else {
            return $this->___callPlugins('getProductListBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function subString($str, $strLenght)
    {
        ...
        if (!$pluginInfo) {
            return parent::subString($str, $strLenght);
        } else {
            return $this->___callPlugins('subString', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getElementShow()
    {
        ...
        if (!$pluginInfo) {
            return parent::getElementShow();
        } else {
            return $this->___callPlugins('getElementShow', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFilterData()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getFilterData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSliderData()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSliderData();
        } else {
            return $this->___callPlugins('getSliderData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getGridData()
    {
        ...
        if (!$pluginInfo) {
            return parent::getGridData();
        } else {
            return $this->___callPlugins('getGridData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSwatchesBlock()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSwatchesBlock();
        } else {
            return $this->___callPlugins('getSwatchesBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getImageHtml($product, $width, $height, $imageHelper)
    {
        ...
        if (!$pluginInfo) {
            return parent::getImageHtml($product, $width, $height, $imageHelper);
        } else {
            return $this->___callPlugins('getImageHtml', func_get_args(), $pluginInfo);
        }
    }
