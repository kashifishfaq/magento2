    ...
    \Magento\Framework\Data\Form\Element\Renderer\RendererInterface
{
    ...
    protected $scopeStore = ['is_active', 'content', 'label_image', 'label_background', 'custom_class', 'custom_css'];
    
    protected $scopeGlobal = ['entity_id', 'store', 'title'];
     ...
     * @var string
     */
    protected $_template = 'Codazon_ProductLabel::productlabel/content_html/renderer/fieldset/element.phtml';
    ...
    {
    	if (in_array($this->getElement()->getName(), $this->scopeGlobal)) {
    		return true;
    	} else {
    		return false;
    	}
    ...
    {
    	if (in_array($this->getElement()->getName(), $this->scopeStore)) {
    		return true;
    	} else {
    		return false;
    	}
